...
spawn /deposit --non_interactive --language english new-mnemonic  --mnemonic_language english --num_validators $num_validators --chain bidao --execution_address $execution_address
